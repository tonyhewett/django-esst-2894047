...
SECRET_KEY = "django-insecure-9(gja#=*pbk4awpz#pug+lltwqa@5j6yjg$$s01ek(=d5m4mb7"
...
# CSRF_TRUSTED_ORIGINS fix for codespace error (although wasn't having a problem   )
